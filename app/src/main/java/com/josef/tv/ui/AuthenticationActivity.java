    ...
    public static class FirstStepFragment extends GuidedStepSupportFragment {
        ...
        public void onGuidedActionClicked(GuidedAction action) {
            if (action.getId() == CONTINUE) {
                ...
                String email = getContext().getSharedPreferences("com.josef.tv.prefs.main",
                        Context.MODE_PRIVATE).getString("com.josef.tv.auth.email", "default");
                String password = getContext().getSharedPreferences("com.josef.tv.prefs.main",
                        Context.MODE_PRIVATE).getString("com.josef.tv.auth.password", "default");
